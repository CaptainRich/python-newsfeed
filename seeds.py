...
db = Session()    #start a temporary session to allow CRUD operations
...
db.commit()    #this statement actually runs the MySQL 'INSERT" statements.


# insert posts, note that 'users' must exist first because of the 'user_id' field.
db.add_all([
...
db.close()     #end the temporary session